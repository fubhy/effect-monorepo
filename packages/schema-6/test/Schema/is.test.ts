import * as P from "@effect/schema-6/Parser"
...
describe("Schema/is", () => {
  ...
  it("symbol", () => {
    ...
    expect(is(a)).toEqual(true)
    expect(is("@effect/schema-6/test/a")).toEqual(false)
  })
  ...
  it("uniqueSymbol", () => {
    ...
    const is = P.is(schema)
    expect(is(a)).toEqual(true)
    expect(is(Symbol.for("@effect/schema-6/test/a"))).toEqual(true)
    expect(is("Symbol(@effect/schema-6/test/a)")).toEqual(false)
  })
