import * as P from "@effect/schema-13/Parser"
...
describe("Schema/is", () => {
  ...
  it("symbol", () => {
    ...
    expect(is(a)).toEqual(true)
    expect(is("@effect/schema-13/test/a")).toEqual(false)
  })
  ...
  it("uniqueSymbol", () => {
    ...
    const is = P.is(schema)
    expect(is(a)).toEqual(true)
    expect(is(Symbol.for("@effect/schema-13/test/a"))).toEqual(true)
    expect(is("Symbol(@effect/schema-13/test/a)")).toEqual(false)
  })
