import * as P from "@effect/schema-10/Parser"
...
describe("Schema/is", () => {
  ...
  it("symbol", () => {
    ...
    expect(is(a)).toEqual(true)
    expect(is("@effect/schema-10/test/a")).toEqual(false)
  })
  ...
  it("uniqueSymbol", () => {
    ...
    const is = P.is(schema)
    expect(is(a)).toEqual(true)
    expect(is(Symbol.for("@effect/schema-10/test/a"))).toEqual(true)
    expect(is("Symbol(@effect/schema-10/test/a)")).toEqual(false)
  })
